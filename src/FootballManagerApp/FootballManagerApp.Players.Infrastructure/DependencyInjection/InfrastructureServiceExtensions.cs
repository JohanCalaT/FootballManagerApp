...
public static class InfrastructureServiceExtensions
{
    ...
    public static IServiceCollection AddInfrastructure(this IServiceCollection services)
    {
        ...
        // Gemini: adapter sobre el SDK oficial Google.GenAI. El SDK gestiona su
        // propio transporte (HttpClient + reintentos internos), por eso no
        // colgamos aquí un pipeline Polly. Singleton para reutilizar el cliente
        // interno entre peticiones. La resiliencia "dura" (Circuit Breaker,
        // matrícula DWSC) vive en CommentsClient, no en Gemini.
